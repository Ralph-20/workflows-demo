        ...
        <PanelBody className="flex-1">
          ...
          {rows.length > 0 ? (
            <>
              ...
              {summary ? (
                <WhatThisShows>
                  Fan out as wide as you like without managing queues or
                  workers — one <code className="font-mono text-fg">Promise.all</code>{" "}
                  did it. {summary.sumMs} ms of work finished in{" "}
                  {summary.wallMs} ms, and each branch stayed its own retryable,
                  durable unit rather than one big job that restarts from the
                  top.
                </WhatThisShows>
              ) : null}
